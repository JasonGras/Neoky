...
public class Swordman : PlayerController
{
    ...
    private void Start()
    {
        ...
        // Get the Animator Component on the Model
    ...
    //{
        //Transform myCrewMemberTransform = this.GetComponent<Transform>();
        //if (myCrewMemberTransform.position == GameObject.Find("Spawn"+GameObject.Find("")).transform.position)
        //{
